            ...
            <div class="d-flex align-items-start row">
                <div class="col-sm-7">
                    <div class="card-body">
                        ...
                        <p class="mb-6">
                            Your financial overview for <span id="currentDate"></span>.<br>
                            You have <strong>$12,458.50</strong> total balance with <strong>18</strong> active transactions this month.
                        </p>

                        <div class="d-flex gap-2">
                            <a href="{{ route('payments.initiate') }}" class="btn btn-sm btn-primary">Send Payment</a>
                            <a href="{{ route('payouts.initiate') }}" class="btn btn-sm btn-outline-success">Request Payout</a>
                            <a href="{{ route('billpay.create') }}" class="btn btn-sm btn-outline-info">Add Bill</a>
                        </div>
                    </div>
                </div>
